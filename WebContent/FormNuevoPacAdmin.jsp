...
<input class="col-lg-offset-1 col-lg-2" type = "text" name= "dni" placeholder = "DNI"/>
<br><br>
<input class="col-lg-6" type = "text" name= "domicilio" placeholder = "Dirección Completa"/>
<input class="col-lg-offset-1 col-lg-1" type = "text" name= "edad" placeholder = "Edad"/>
<input class="col-lg-offset-1 col-lg-3" type = "text" name= "movil" placeholder = "Número de teléfono"/>
<br><br>
